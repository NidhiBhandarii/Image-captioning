...
# LOADING DATA
vocab = pickle.load(open('models/vocab_coco.file', 'rb'))
...
def load_image_from_path(img_path):
    ...
    img = tf.cast(img, tf.float32)  # Convert to float32 before preprocessing
...
def get_caption_model():
    ...
    try:
        caption_model.load_weights('models/image_captioning_coco_weights.h5')
